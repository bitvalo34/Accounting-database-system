        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="../reportes/diario.php">Diario</a>
              <a class="dropdown-item" href="../reportes/mayor.php">Mayor</a>
              <a class="dropdown-item" href="../reportes/balance.php">Balance</a>
            </div>
          </li>
        </ul>
      </div>
